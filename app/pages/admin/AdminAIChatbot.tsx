  ...
  return (
    <DashboardLayout role="admin">
      ...
      <div className="grid md:grid-cols-4 gap-4 mb-8">
        {[
          { label: "Total Queries", value: "8,756", icon: MessageSquare, color: "#E53935" },
        ...
        <div className="lg:col-span-2 space-y-6">
          <Card className="p-6 bg-white shadow-sm border border-gray-100">
            ...
            <div className="space-y-3">
              {faqs.map((faq, index) => (
                <div key={index} className="flex items-center justify-between p-4 bg-gray-50 rounded-xl border border-gray-100 group hover:border-[#E53935]/30 transition-all">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <Button variant="outline" size="sm" className="bg-white border-gray-200 group-hover:border-[#E53935]">Edit</Button>
                  </div>
                </div>
              ))}
            </div>
            ...
            <div className="space-y-4">
              {unresolvedDoubts.map((doubt, index) => (
                <div key={index} className="p-4 bg-white border border-gray-100 rounded-xl relative group overflow-hidden">
                  <div className="absolute top-0 left-0 w-1 h-full" style={{ background: doubt.priority === "High" ? "#E53935" : doubt.priority === "Medium" ? "#FF9800" : "#4CAF50" }} />
                  ...
                  <div className="flex items-center justify-between mt-3">
                    ...
                    <Button size="sm" className="h-7 text-[11px] px-3 border-[#E53935] text-[#E53935] bg-white border" variant="outline">Answer Now</Button>
                  </div>
                </div>
              ))}
            </div>
